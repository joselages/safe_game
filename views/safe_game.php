...
<body>
    <main class="safe">
        ...
        <section class="safe_inside">
            <img class="inside-img" src="https://super.abril.com.br/wp-content/uploads/2020/09/04-09_gato_SITE.jpg?quality=70&strip=info">
        ...
        <span class="safe_creator">Safe created by: <a href="./safe_list.php">Name</a></span>
    </main>
